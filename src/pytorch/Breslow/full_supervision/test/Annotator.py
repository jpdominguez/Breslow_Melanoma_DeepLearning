...
OUTPUT_PATH_ANNOTATIONS = 'E:\\Breslow\\src\\pytorch\\experiments\\Breslow\\full_supervision\\test\\teacher_annotations\\'
CSV_PATH = 'E:\\Breslow\\Melanomas ISIC filtro DC 27-01-23\\metadata.csv'
IMAGES_PATH = 'E:\\Breslow\\Melanomas ISIC filtro DC 27-01-23\\'
...
if FOLD != 'majority':
	...
	preds_filename = OUTPUT_PATH_ANNOTATIONS + 'preds_raw_' + 'N_EXP_' + str(N_EXP) + '_majority.csv'

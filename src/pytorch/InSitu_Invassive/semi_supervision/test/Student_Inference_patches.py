...
for i in range(5):
	...
	test_dataset = pd.read_csv('E:\\Breslow\\src\\pytorch\\experiments\\InSitu_Invassive\\semi_supervision\\train\\models\\' + MODEL + '\\N_EXP_' + str(N_EXP) + '\\Fold_' + str(i) + '\\validation_df.csv')#,header=None)
	...
	# fpr, tpr, thresholds = metrics.roc_curve(y_true, outputs_np)

...
PATH_RESULTS_TEACHER = 'E:\\Breslow\\src\\pytorch\\experiments\\InSitu_Invassive\\full_supervision\\'
...
shutil.copy(dir_best_N_EXP + 'plot_cm_InSitu_Invassive.svg', dir_output + 'best_plot_cm_InSitu_Invassive_with_Teacher.svg')
shutil.copy(dir_best_N_EXP + 'plot_roc_curve_InSitu_Invassive.svg', dir_output + 'best_plot_roc_curve_InSitu_Invassive_with_Teacher.svg')

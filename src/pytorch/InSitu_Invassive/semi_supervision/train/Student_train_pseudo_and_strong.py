...
pretrained_models_path = 'E:\\Breslow\\src\\pytorch\\experiments\\InSitu_Invassive\\full_supervision\\train\\models\\' +MODEL+'\\' + 'N_EXP_'+N_EXP_str+'\\'


models_path = 'E:\\Breslow\\src\\pytorch\\experiments\\InSitu_Invassive\\semi_supervision\\train\\models\\'
...
CSV_PATH_PSEUDO = 'E:\\Breslow\\src\\pytorch\\experiments\\InSitu_Invassive\\full_supervision\\test\\teacher_annotations\\preds_raw_N_EXP_13_majority.csv'
...
csv_df_pseudo.columns = ['IMAGE_PATH', 'label', 'Tis_inv']
...
print('Invassive:', len(csv_df_pseudo_shuffled[csv_df_pseudo_shuffled.Tis_inv == 0]))
print('In situ:', len(csv_df_pseudo_shuffled[csv_df_pseudo_shuffled.Tis_inv == 1]))
print('------------------------')
...
for i in range(5):
	...
	train_df.to_csv(models_path_fold+'train_df.csv', index = False, header=True, columns=['IMAGE_PATH','Tis_inv'])
	test_df.to_csv(models_path_fold+'validation_df.csv', index = False, header=True, columns=['IMAGE_PATH','Tis_inv'])
